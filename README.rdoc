...
- tiny_mce/lib/tiny_mce/assets/tiny_mce/themes/simple/langs/lang-BL_dlg.js

Now you can translate the basic tinyMCE. Remember that if you use some plugin you have to make it manual.
