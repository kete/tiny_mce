...
Note: in light of the improvements for JavaScript libraries in Rails 3.1's asset pipeline, this gem/plugin is NOT recommended for Rails 3.1 or above. I encourage someone to create a new gem, say tinymce-rails (ala jquery-rails gem at https://github.com/rails/jquery-rails), that works with the improvements in Rails 3.1!
